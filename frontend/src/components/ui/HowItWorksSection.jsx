    ...
    <section className="py-20 lg:py-32 relative">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          {/* Connection Lines */}
          <div className="hidden md:block absolute top-1/2 left-1/4 right-1/4 h-[1px] bg-gradient-to-r from-transparent via-neutral-700 to-transparent" />
          ...
          {steps.map((item, index) => {
            ...
            return (
              ...
              >
                {/* Step Number */}
                <div className="text-7xl font-bold text-neutral-900 mb-4 select-none">
                  {item.step}
                </div>

                {/* Icon */}
                <div className="w-16 h-16 mx-auto mb-6 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl blur-xl opacity-30" />
